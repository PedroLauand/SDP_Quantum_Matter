"""Readable example script for the real-restricted level-2 GHZ robustness SDP."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Build or solve the real-restricted SCS level-2 inflation robustness SDP for GHZ.",
    )
