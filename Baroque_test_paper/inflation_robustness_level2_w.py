"""Readable example script for the full-coordinate level-2 W robustness SDP."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Build or solve the full-coordinate SCS level-2 inflation robustness SDP for W.",
    )
