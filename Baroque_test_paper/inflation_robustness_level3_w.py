"""Readable example script for the full-coordinate level-3 W robustness SDP."""
...
try:
    from level3_complex_model import (
        DEFAULT_SCS_ACCELERATION_INTERVAL,
        DEFAULT_SCS_ACCELERATION_LOOKBACK,
        DEFAULT_SCS_ALPHA,
        DEFAULT_SCS_RHO_X,
        DEFAULT_SCS_SCALE,
        build_inflation_robustness_level3_scs_model,
        solve_inflation_robustness_level3_scs,
    )
except ModuleNotFoundError:
    from Baroque_test_paper.level3_complex_model import (
        DEFAULT_SCS_ACCELERATION_INTERVAL,
        DEFAULT_SCS_ACCELERATION_LOOKBACK,
        DEFAULT_SCS_ALPHA,
        DEFAULT_SCS_RHO_X,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Build or solve the full-coordinate SCS level-3 inflation robustness SDP for W.",
    )
