"""Readable example script for the real-restricted level-2 W robustness SDP."""
...
try:
    from level2_real_restricted_model import (
        DEFAULT_SCS_ACCELERATION_INTERVAL,
        DEFAULT_SCS_ACCELERATION_LOOKBACK,
        DEFAULT_SCS_ALPHA,
        DEFAULT_SCS_RHO_X,
        DEFAULT_SCS_SCALE,
        build_inflation_robustness_level2_real_restricted_scs_model,
        solve_inflation_robustness_level2_real_restricted_scs,
    )
except ModuleNotFoundError:
    from Baroque_test_paper.level2_real_restricted_model import (
        DEFAULT_SCS_ACCELERATION_INTERVAL,
        DEFAULT_SCS_ACCELERATION_LOOKBACK,
        DEFAULT_SCS_ALPHA,
        DEFAULT_SCS_RHO_X,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Build or solve the real-restricted SCS level-2 inflation robustness SDP for W.",
    )
