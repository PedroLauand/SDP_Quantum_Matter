"""Readable example script for the real-restricted level-3 GHZ robustness SDP."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Build or solve the real-restricted SCS level-3 inflation robustness SDP for GHZ.",
    )
